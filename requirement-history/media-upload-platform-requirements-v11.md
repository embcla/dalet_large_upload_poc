...
## 13. Stretch Goal — Playback/Use During Upload (Scoping Notes)

The idea of using a file "while it's being uploaded" to S3-compatible storage is genuinely advanced and worth scoping carefully **after** M1–M8 are stable:
...
## 14. Future Expansion: TLS/HTTPS via Edge Reverse Proxy (Not Required Now)
...
## 15. Recommended Tech Stack Summary
